...
export class MemberMembershipFeePaymentRequestedHandler implements IViewUpdater<MemberMembershipFeePaymentRequested> {
    constructor(private readonly repository: Repository<Member>,
        private readonly mapperService: MapperService
    ) { }

    public async handle(event: MemberMembershipFeePaymentRequested): Promise<void> {
