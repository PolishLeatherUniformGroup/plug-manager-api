...
export class Migrations1725565131083 implements MigrationInterface {
    name = 'Migrations1725565131083'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`membership_application_statuses\` (\`id\` int NOT NULL AUTO_INCREMENT, \`status\` int NOT NULL, \`date\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`comment\` text NULL, \`applicantId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`membership_member_suspensions\` ADD CONSTRAINT \`FK_119a1258b96a13bf24b8bb142c3\` FOREIGN KEY (\`memberId\`) REFERENCES \`membership_members\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`membership_member_expulsions\` ADD CONSTRAINT \`FK_ee8899417df2302b02c5bec98d2\` FOREIGN KEY (\`memberId\`) REFERENCES \`membership_members\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`membership_member_fees\` ADD CONSTRAINT \`FK_95ee47d4b7d215be7f373f93f5a\` FOREIGN KEY (\`memberId\`) REFERENCES \`membership_members\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`membership_application_statuses\` ADD CONSTRAINT \`FK_3d7bba0b715703e17b9913612c9\` FOREIGN KEY (\`applicantId\`) REFERENCES \`membership_applicants\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`membership_application_statuses\` DROP FOREIGN KEY \`FK_3d7bba0b715703e17b9913612c9\``);
        ...
        await queryRunner.query(`DROP TABLE \`membership_application_statuses\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_05029a761f34cc328afd98feeb\` ON \`membership_members\``);
        await queryRunner.query(`DROP TABLE \`membership_members\``);
